...
const MPSCAgricultureServices = () => {
  return (
    <div className="space-y-8">
      <div className="text-center mb-12">
        <h1 className="text-4xl md:text-5xl font-bold mb-4" style={{color: '#1e3a8a'}}>
          MPSC Agriculture Services Examination
        </h1>
        <p className="text-xl text-gray-600">
          Complete guide to MPSC Agriculture Services - Pattern, Syllabus & Eligibility
        </p>
      </div>
        ...
        <Card className="bg-gradient-to-r from-blue-50 to-blue-100 border-blue-200">
          <CardContent className="flex items-center p-6">
            ...
            <div>
              ...
              <p className="text-sm text-gray-600">Agriculture Degree</p>
            </div>
          </CardContent>
        </Card>
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="text-gray-700 leading-relaxed mb-8">
          <ul className="space-y-2">
            ...
            <li>• Services: Agriculture Officer, Assistant Agriculture Officer, Horticulture Officer</li>
            <li>• Specializations: Agronomy, Horticulture, Plant Pathology, Entomology, Soil Science</li>
          </ul>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
          <div>
            ...
            <ul className="space-y-2 text-gray-700">
              ...
              <li>• Paper II: Agriculture Sciences (300 marks, 2 hours)</li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-700">
              ...
              <li>• Paper II: General Agriculture (200 marks, 3 hours)</li>
              <li>• Paper III: Agriculture Subject - Part A (300 marks, 3 hours)</li>
              <li>• Paper IV: Agriculture Subject - Part B (300 marks, 3 hours)</li>
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
          <div>
            ...
            <ul className="space-y-2 text-gray-700">
              <li>• Bachelor's degree in Agriculture or related field</li>
              <li>• ICAR recognized agriculture degree required</li>
              <li>• Final year students can apply</li>
              <li>• Specializations: Agronomy, Horticulture, Plant Pathology, etc.</li>
            </ul>
          </div>
          <div>
            ...
            <ul className="space-y-2 text-gray-700">
              ...
              <li>• Valid agriculture degree certificate required</li>
              <li>• Field experience preferred but not mandatory</li>
            </ul>
          </div>
        </div>
      ...
      <div className="max-w-4xl mx-auto">
          ...
          <Card className="hover:shadow-lg transition-all duration-300 bg-gradient-to-r from-blue-50 to-blue-100 border-blue-200">
            <CardContent className="flex items-center p-4">
              ...
              <div>
                ...
                <p className="text-sm text-blue-600">General Studies and Agriculture Sciences</p>
              </div>
            </CardContent>
          </Card>
          ...
          <Card className="hover:shadow-lg transition-all duration-300 bg-gradient-to-r from-green-50 to-green-100 border-green-200">
            <CardContent className="flex items-center p-4">
              ...
              <div>
                ...
                <p className="text-sm text-green-600">4 Papers including Agriculture Subjects</p>
              </div>
            </CardContent>
          </Card>
        ...
        <div className="text-center">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <button 
              onClick={() => window.open('/sample-pdfs/mpsc-agriculture-prelims-syllabus.pdf', '_blank')}
            ...
            <button 
              onClick={() => window.open('/sample-pdfs/mpsc-agriculture-mains-syllabus.pdf', '_blank')}
              className="bg-[#003060] hover:bg-[#002040] text-white px-6 py-3 rounded-xl font-semibold inline-flex items-center justify-center gap-2"
            >
              <Download className="w-4 h-4" />
              Mains Syllabus
            ...
            <button 
              onClick={() => window.open('/sample-pdfs/mpsc-agriculture-subjects.pdf', '_blank')}
              className="bg-[#003060] hover:bg-[#002040] text-white px-6 py-3 rounded-xl font-semibold inline-flex items-center justify-center gap-2"
            >
              <Download className="w-4 h-4" />
...
export default MPSCAgricultureServices;
