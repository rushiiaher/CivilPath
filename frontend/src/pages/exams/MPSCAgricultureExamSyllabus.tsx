...
const MPSCAgricultureExamSyllabus = () => {
  return (
    <div className="space-y-8">
      <div className="text-center mb-12">
        <h2 className="text-2xl md:text-3xl font-bold mb-4" style={{color: '#1e3a8a'}}>
          MPSC Agriculture Services Syllabus
        </h2>
        <p className="text-xl text-gray-600">
          Comprehensive syllabus for MPSC Agriculture Services Examination
        </p>
      </div>
...
export default MPSCAgricultureExamSyllabus;
