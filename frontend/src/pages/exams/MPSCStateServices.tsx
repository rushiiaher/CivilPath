...
const MPSCStateServices = () => {
  return (
    <div className="space-y-8">
      <div className="text-center mb-12">
        <h1 className="text-4xl md:text-5xl font-bold mb-4" style={{color: '#1e3a8a'}}>
          MPSC State Service Examination
        </h1>
        <p className="text-xl text-gray-600">
          Complete guide to MPSC State Service - Pattern, Syllabus & Eligibility
        </p>
      </div>
        ...
        <Card className="bg-gradient-to-r from-green-50 to-green-100 border-green-200">
          <CardContent className="flex items-center p-6">
            ...
            <div>
              ...
              <p className="text-sm text-gray-600">19-38 years (General)</p>
            </div>
          </CardContent>
        </Card>
        <Card className="bg-gradient-to-r from-purple-50 to-purple-100 border-purple-200">
          <CardContent className="flex items-center p-6">
            ...
            <div>
              ...
              <p className="text-sm text-gray-600">Group A & B Officers</p>
            </div>
          </CardContent>
        </Card>
      </div>
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
          <div>
            ...
            <ul className="space-y-2 text-gray-700">
              ...
              <li>• Professional degrees are eligible</li>
            </ul>
          </div>
          <div>
        ...
        <div>
          <h3 className="text-2xl font-bold mb-4" style={{color: '#1e3a8a'}}>Domicile Requirements</h3>
...
export default MPSCStateServices;
